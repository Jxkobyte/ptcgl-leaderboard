...
The installer bundles these components unmodified. Each is the work of its own authors and is
...
| Unity Doorstop | `winhttp.dll`, `doorstop_config.ini` | LGPL-2.1 | https://github.com/NeighTools/UnityDoorstop |
